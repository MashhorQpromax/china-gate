    ...
    return (
      <div className="bg-[#1a1d23] border border-[#242830] rounded-lg p-4 hover:border-[#d4a843] transition-colors">
        <div className="flex gap-4 items-start">
          {/* Image */}
          <div
            className="w-24 h-24 rounded-lg flex-shrink-0 flex items-center justify-center flex-col justify-center"
            style={{
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="px-4 py-1 bg-[#c41e3a] bg-opacity-20 text-[#c41e3a] rounded text-sm hover:bg-opacity-30 transition-colors">
                View
              </button>
            </div>
  ...
  return (
    <div className="bg-[#1a1d23] border border-[#242830] rounded-lg overflow-hidden hover:border-[#d4a843] transition-all duration-200 hover:shadow-lg hover:shadow-[#c41e3a]20 group cursor-pointer">
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Action Button */}
        <button className="w-full mt-3 px-3 py-2 bg-[#c41e3a] bg-opacity-20 text-[#c41e3a] rounded-lg hover:bg-opacity-30 transition-colors font-semibold text-sm">
          View Details
        </button>
      </div>
    </div>
